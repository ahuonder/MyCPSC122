 ...
 */
  ...
  /*
  pre: postFix exists. There are 2 letters in the stack that correlate to the value table.
  post: the desired operation will be done to the 2 numbers in the stack.
        the new value will be stored in the value table, with the corresponding letter
        in the stack. 
  */
  void Compute(char operation);
